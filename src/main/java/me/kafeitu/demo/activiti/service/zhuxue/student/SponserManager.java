...
//        this.<Exam>cleanEmpty(exams);
   ...
   */     
    	List<Student> students = studentManager.getAllStudentBysponserId(entity.getSponserNo());
    	logger.error("allstudentbysponserid:"+ students.size());
    	entity.setStudentsToSponse(students);
