    ...
    $('.trace').click(graphTrace);
     $.each($('.div_maindialog'),function(){
    	if(this.id=='editsponser')
    		this.innerHTML=this.innerHTML.replace('<a target=showpic class="sponserPhoto" id="sponser_picture" name="picture" style="width: 189px" //>','<input type="file" class="sponserPhoto" id="sponser_picture" name="picture" style="width: 189px" //>没有图片<//a>');
