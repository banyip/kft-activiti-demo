...
<table border="0" cellpadding="0" cellspacing="0" width="809" style="border-collapse:
 ...
 width:34pt" />
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		<td colspan="3" height="24" width="81" style="height: 18.0pt; width: 61pt" class="style2">
		家长姓名</td>
		<td width="101" style="width: 76pt" class="style5" >李大华</td>
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		...
		学生成绩</td>
		<td width="101" style="width: 76pt" class="style9">语文：<span style="mso-spacerun:yes">&nbsp;
		</span>分</td>
		<td colspan="2" width="106" style="width: 80pt" class="style9">数学：<span style="mso-spacerun:yes">&nbsp;&nbsp;
		</span>分</td>
		<td colspan="2" width="106" style="width: 80pt" class="style10">英语：<span style="mso-spacerun:yes">&nbsp;&nbsp;
		</span>分</td>
		<td colspan="3" width="207" style="width: 156pt" class="style10">其他学科：<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</span>分</td>
		<td colspan="3" width="122" style="width: 92pt" class="style10">综合成绩排名：</td>
		<td width="86" style="width: 65pt" class="style11">名</td>
	</tr>
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		...
		<td width="53" style="width: 40pt" class="style13">文化</td>
		<td width="101" style="width: 76pt" class="style13">职业或就读</td>
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		...
		<td colspan="4" width="212" style="width: 160pt" class="style4">　</td>
		<td width="53" style="width: 40pt" class="style2">　</td>
		<td width="53" style="width: 40pt" class="style13">　</td>
		<td width="101" style="width: 76pt" class="style16">　</td>
		<td width="45" style="width: 34pt" class="style2">　</td>
		<td colspan="3" width="163" style="width: 123pt" class="style4">　</td>
	</tr>
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		<td colspan="2" height="24" width="40" style="height: 18.0pt; width: 30pt" class="style7">
		　</td>
		<td width="101" style="width: 76pt" class="style15">　</td>
		<td colspan="4" width="212" style="width: 160pt" class="style7">　</td>
		<td width="53" style="width: 40pt" class="style15">　</td>
		<td width="53" style="width: 40pt" class="style16">　</td>
		<td width="101" style="width: 76pt" class="style17">　</td>
		<td width="45" style="width: 34pt" class="style18">　</td>
		<td colspan="3" width="163" style="width: 123pt" class="style7">　</td>
	</tr>
