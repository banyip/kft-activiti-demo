...
<table border="0" cellpadding="0" cellspacing="0" width="809" style="border-collapse:
 ...
 width:34pt" />
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		...
		<input class=toinput id=relatives[0]_RelationShip name=relationship disabled="disabled" />　</td>
		<td style="width: 68pt" class="style3">
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		<td colspan="2" height="24" width="40" style="height: 18.0pt; width: 30pt" class="style6">
		<input class=toinput id=relatives[1]_RelationShip name=relationship  disabled="disabled" />　</td>
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		<td colspan="2" height="24" width="40" style="height: 18.0pt; width: 30pt" class="style6">
		<input class=toinput id=relatives[2]_RelationShip name=relationship  disabled="disabled" /></td>
		<td style="width: 68pt" class="style3">　</td>
		<td colspan="4" class="style4">　</td>
		<td width="53" style="width: 40pt" class="style3">　</td>
		<td width="53" style="width: 40pt" class="style13">　</td>
	...
	<tr style="mso-height-source: userset;">
		...
		　<input class=toinput id=relatives[3]_RelationShip name=relationship  disabled="disabled" /></td>
