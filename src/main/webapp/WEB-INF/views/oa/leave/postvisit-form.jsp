...
<table border="0" cellpadding="0" cellspacing="0" width="809" style="border-collapse:
 ...
 width:34pt" />
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt">
		...
		<td colspan="2" width="146" style="width: 110pt" class="student" name="studentId"><input id=StudentId name="studentId"></input></td>
	...
	<tr height="24" style="mso-height-source:userset;height:18.0pt" class="relative">
 	...
 	<tr height="24" style="mso-height-source:userset;height:18.0pt" class="relative">
  	...
  	<tr height="24" style="mso-height-source:userset;height:18.0pt" class="relative">
   	...
   	<tr height="24" style="mso-height-source:userset;height:18.0pt" class="relative">
		<td colspan="2" height="24" width="40" style="height: 18.0pt; width: 30pt" class="partly" id="relatives[5].relationship"></td>
