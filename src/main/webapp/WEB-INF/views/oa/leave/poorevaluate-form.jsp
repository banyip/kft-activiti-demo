		...
		<input class="poorevaluate" id="leave_Grade" name=grade style="width: 42px"  disabled="disabled"/><input class="poorevaluate" id="leave_ClassName" name=className disabled="disabled" style="width: 42px"/>　</td>
			...
			<input class="poorevaluate" id="leave_applicantName" name="applicantName"  disabled="disabled" />　</td>
				...
				<tr height="64" style="mso-height-source:userset;height:48.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore0" name="leave_poorEvaluateScore0" type="number" /></td>
				</tr>
				<tr height="113" style="mso-height-source:userset;height:85.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore1" name="leave_poorEvaluateScore1" type="number" /></td>
				</tr>
				<tr height="73" style="mso-height-source:userset;height:55.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore2" name="leave_poorEvaluateScore2" type="number" />　</td>
				</tr>
				<tr height="53" style="mso-height-source:userset;height:40.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore3" name="leave_poorEvaluateScore3" type="number" /></td>
				</tr>
				<tr height="47" style="mso-height-source:userset;height:35.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore4" name="leave_poorEvaluateScore4" type="number" /></td>
				</tr>
				<tr height="73" style="mso-height-source:userset;height:55.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore5" name="leave_poorEvaluateScore5" type="number" />　</td>
				</tr>
				<tr height="73" style="mso-height-source:userset;height:55.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore6" name="leave_poorEvaluateScore6" type="number" />　</td>
				</tr>
				<tr height="53" style="mso-height-source:userset;height:40.0pt">
								<td colspan="6" height="53" width="560" style="height: 40.0pt; width: 421pt" class="style5">
								2.年度获得2000元以下贫困补助的（5-10分），年度获得2000元以上贫困补助的（0-5分）；</td>
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore7" name="leave_poorEvaluateScore7" type="number" />　</td>
				</tr>
				<tr height="76" style="mso-height-source:userset;height:57.0pt">
								...
								3.其他情况说明（0-15分）：</td>
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore8" name="leave_poorEvaluateScore8" type="number" />　</td>
				</tr>
				<tr height="47" style="mso-height-source:userset;height:35.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateTotalScore" name="leave_poorEvaluateTotalScore" type="number"  disabled="disabled" onclick="countPoorScore()"/>　</td>
				</tr>
