...
<table border="0" cellpadding="0" cellspacing="0" width="731" style="border-collapse:
 collapse;width:550pt">
		...
		<input class="poorevaluate" id="leave_School" name=school style="width:95%" disabled="disabled" /></td>
								<td width="63" style="width: 48pt" class="style2">
								姓名</td>
								<td width="115" style="width: 86pt" class="style3">
			<input class="poorevaluate" id="leave_StudentName" name="studentName"  disabled="disabled"/>　</td>
								<td width="63" style="width: 48pt" class="style2">
								班级</td>
								<td width="115" style="width: 86pt" class="style3">
		<input class="poorevaluate" id="leave_Grade" name=grade style="width: 42px"  disabled="disabled"/><input class="poorevaluate" id="leave_ClassName" name=className disabled="disabled" style="width: 42px"/>　</td>
								<td width="71" style="width: 53pt" class="style2">
								申请人</td>
								<td width="95" style="width: 72pt" class="style3">
			<input class="poorevaluate" id="leave_applicantName" name="applicantName"  disabled="disabled" />　</td>
				</tr>
				<tr height="47" style="mso-height-source:userset;height:35.0pt">
								<td height="47" width="76" style="height: 35.0pt; width: 57pt" class="style2">
								项目</td>
				...
				<tr height="64" style="mso-height-source:userset;height:48.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore0" name="leave_poorEvaluateScore0" type="number" value=0 /></td>
				</tr>
				<tr height="113" style="mso-height-source:userset;height:85.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore1" name="leave_poorEvaluateScore1" type="number" value=0 /></td>
				</tr>
				<tr height="73" style="mso-height-source:userset;height:55.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore2" name="leave_poorEvaluateScore2" type="number" value=0 />　</td>
				</tr>
				<tr height="53" style="mso-height-source:userset;height:40.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore3" name="leave_poorEvaluateScore3" type="number" value=0 /></td>
				</tr>
				<tr height="47" style="mso-height-source:userset;height:35.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								　<input class="poorevaluate" id="leave_poorEvaluateScore4" name="leave_poorEvaluateScore4" type="number" value=0 /></td>
				</tr>
				<tr height="73" style="mso-height-source:userset;height:55.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore5" name="leave_poorEvaluateScore5" type="number" value=0 />　</td>
				</tr>
				<tr height="73" style="mso-height-source:userset;height:55.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore6" name="leave_poorEvaluateScore6" type="number" value=0 />　</td>
				</tr>
				<tr height="53" style="mso-height-source:userset;height:40.0pt">
								<td colspan="6" height="53" width="560" style="height: 40.0pt; width: 421pt" class="style5">
								2.年度获得2000元以下贫困补助的（5-10分），年度获得2000元以上贫困补助的（0-5分）；</td>
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore7" name="leave_poorEvaluateScore7" type="number" value=0 />　</td>
				</tr>
				<tr height="76" style="mso-height-source:userset;height:57.0pt">
								...
								3.其他情况说明（0-15分）：</td>
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateScore8" name="leave_poorEvaluateScore8" type="number" value=0 />　</td>
				</tr>
				<tr height="47" style="mso-height-source:userset;height:35.0pt">
								...
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateTotalScore" name="leave_poorEvaluateTotalScore" type="number" value=0  disabled="disabled" onclick="countPoorScore()"/>　</td>
				</tr>
				<tr height="224" style="mso-height-source:userset;height:168.0pt">
								...
								<textarea class="poorevaluate" id="leave_poorEvaluateNote" name="leave_poorEvaluateNote" style="height:95%;width:95%" name="TextArea1" cols="20" ></textarea>　</td>
				</tr>
				<tr height="44" style="mso-height-source:userset;height:33.0pt">
								...
								　<input class="poorevaluate" id="leave_poorEvaluatePerson" name="poorEvaluatePerson" /></td>
								<td width="115" style="width: 86pt" class="style2">
								电话</td>
								<td colspan="2" width="178" style="width: 134pt" class="style9">
								<input class="poorevaluate" id="leave_poorEvaluatePersonContact" name="poorEvaluatePersonContact" />　</td>
								<td width="71" style="width: 53pt" class="style2">
								日期</td>
								<td width="95" style="width: 72pt" class="style3">
								<input class="poorevaluate" id="leave_poorEvaluateDate" name="poorEvaluateDate" value= />　</td>
				</tr>
</table>
</form>
