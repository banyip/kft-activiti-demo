...
<table border="0" cellpadding="0" cellspacing="0" width="898" style="border-collapse: collapse; width: 95%">
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
 	...
 	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td colspan="2" height="26" style="height: 20.1pt; " class="style14">
		<input class="studentEdit" id="student_school" name="school" style="width: 126px" />　</td>
		<td class="style11">
		...
		<td class="style11">
		<input class="studentEdit" id="student_headTeacher" name="headTeacher" style="width: 81px" />　</td>
		<td colspan="3" class="style10">
		<input class="studentEdit" id="student_schoolContactNo" name="schoolContactNo" style="width: 109px" />　</td>
    </tr>
  	<tr height="26" style="mso-height-source:userset;height:20.1pt">
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		<input class="studentEdit" id="student_age" name="age"  style="width: 50px"/>　</td>
		<td class="style11" style="width: 60pt">
		<input class="studentEdit" id="student_sex" name="sex"  style="width: 50px"/>　</td>
		<td class="style11">
		<input class="studentEdit" id="student_qq" name="qq"  style="width: 90px" />　</td>
		<td class="style16" >
		<input class="studentEdit" id="student_email" name="email"  style="width: 90px"/>　</td>
		<td class="style16">
		<input class="studentEdit" id="student_studentContactNo" name="studentContactNo"  style="width: 90px" />　</td>
		<td class="style11">
		<input class="studentEdit" id="student_sponseStartTime" name="sponseStartTime"  style="width: 90px" />　</td>
		<td class="style16">
		<input class="studentEdit" id="student_sponseEndTime" name="sponseEndTime"  style="width: 90px"/>　</td>
		<td class="style17">
		<input class="studentEdit" id="student_endReason" name="endReason"  style="width: 90px"/>　</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		</span>，收入<span style="mso-spacerun:yes"><input  class="studentEdit" id="student_relativeSponseIncome" name="relativeSponseIncome" style="width: 41px" /></span>元/年</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" style="height: 20.1pt layout-flow: vertical-ideographic;" class="style26">
		　</td>
	...
	<tr style="mso-height-source:userset;">
		...
		<input  class="studentEdit" id="student_ifWood" name="ifWood" type="checkbox" /></span>木屋<span style="mso-spacerun:yes">&nbsp;   
		<input  class="studentEdit" id="student_ifTwoFloor" name="ifTwoFloor" type="checkbox" /></span>≥两层<span style="mso-spacerun:yes">&nbsp;</span></td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		<input  class="studentEdit" id="student_ifConcreteTile" name="ifConcreteTile" type="checkbox" /></span>贴瓷砖<span style="mso-spacerun:yes">&nbsp;&nbsp;  
		<input  class="studentEdit" id="student_ifNeat" name="ifNeat" type="checkbox" /></span>舒适整洁<span style="mso-spacerun:yes">&nbsp;&nbsp;
		<input  class="studentEdit" id="student_ifHighClass" name="ifHighClass" type="checkbox" /></span>高档</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td colspan="7" height="26" style="height: 20.1pt" class="style34">2. 
		<input  class="studentEdit" id="student_ifBorrowHouse" name="ifBorrowHouse" type="checkbox" />借用房屋<span style="mso-spacerun:yes">&nbsp;&nbsp; </span>来源：<span style="mso-spacerun:yes"><input  class="studentEdit" id="student_rentFrom" name="rentFrom" style="width: 422px" /></span>。</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		<input  class="studentEdit" id="student_ifRentSimple" name="ifRentSimple" type="checkbox" /></span>简陋<span style="mso-spacerun:yes">&nbsp;&nbsp; 
		<input  class="studentEdit" id="student_ifRentConcreteFloor" name="ifRentConcreteFloor" type="checkbox" /></span>水泥地<span style="mso-spacerun:yes">&nbsp;&nbsp;
		<input  class="studentEdit" id="student_ifRentConcreteTile" name="ifRentConcreteTile" type="checkbox" /></span>贴瓷砖<span style="mso-spacerun:yes">&nbsp;&nbsp; 
		<input  class="studentEdit" id="student_ifRentComfort" name="ifRentComfort" type="checkbox" /></span>舒适<span style="mso-spacerun:yes">&nbsp;&nbsp;
		<input  class="studentEdit" id="student_ifRentHighClass" name="ifRentHighClass" type="checkbox" /></span>高档</td>
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" style="height: 20.1pt; width: 205px;" class="style9">
				<input class="studentEditPhoto" type="text" id="audits[0]_auditPhotos[0]_photoDate" name="auditPhoto[0]_photoDate" style="width: 86px"></td>
		<td class="style11" style="width: 66pt">
		<a class="studentEditPhoto" id="audits[0]_auditPhotos[0]_familyPhoto" name="auditPhoto[0]_familyPhoto" style="width: 80px">显示图片</a></td>
		<td class="style11" style="width: 123px">
		<a class="studentEditPhoto" id="audits[0]_auditPhotos[0]_studentEditPhoto" name="auditPhoto[0]_studentEditPhoto" style="width: 80px">显示图片</a>　</td>
		<td class="style11" style="width: 119px" >
		<a class="studentEditPhoto" id="audits[0]_auditPhotos[0]_feedbackPhoto" name="auditPhoto[0]_feedbackPhoto" style="width: 80px">显示图片</a>　</td>
		<td class="style11" style="width: 98px">
		<a class="studentEditPhoto" id="audits[0]_auditPhotos[0]_recieptphoto" name="auditPhoto[0]_recieptphoto" style="width: 80px">显示图片</a>　</td>
		<td colspan="3" class="style11">
		<a class="studentEditPhoto" id="audits[0]_auditPhotos[0]_otherPhoto" name="auditPhoto[0]_otherPhoto" style="width: 80px">显示图片</a>　</td>
	</tr>
	</table></div>
	</td></tr>
			<tr>
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		<td class="style45"><span style="mso-spacerun:yes"><input  class="studentEdit" id="audit[0]_auditPerson" name="auditPerson" style="width: 81px" /></span></td>
		<td class="style45">电话</td>
		<td colspan="2" class="style85"><span style="mso-spacerun:yes">
		<input  class="studentEdit" id="audit[0]_auditPersonContactNo" name="auditPersonContactNo" style="width: 124px" /></span>&nbsp;</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
