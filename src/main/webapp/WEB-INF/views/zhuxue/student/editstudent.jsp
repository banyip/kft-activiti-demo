...
<table border="0" cellpadding="0" cellspacing="0" width="898" style="border-collapse: collapse; width: 95%">
    ...
    <tr>
	    <td colspan=8>				    		
		    <div id="div_editstudent_relatives">
				<table class="class_editstudent_relatives" width="100%">
					<colgroup>
		<col width="83" >
		<col width="72" span="2" >
		<col width="99" >
		...
		<input class="relative" type="text" id="relatives[0]_health" name="health" style="width: 86px">　</td>
			...
			<tr>
				...
				id="relative" />   
					...
					onclick="inserttable('editstudent_relatives')" />      
					<input
	...
	<tr><td colspan=8>		    <div id="div_editstudent_auditphotos">
				<table class="class_editstudent_auditphotos" width="100%">
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
