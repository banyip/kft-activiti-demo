...
<a target=showpic multiple=multiple class="studentPhoto" type="file" id="communicates[0]_picture" style="visibility:hidden">没有图片</a><input multiple=multiple class="studentPhoto" id="communicates[0]_picture" /></td>
		<td class="style11"  style="width: 15%">
