...
<table border="0" cellpadding="0" cellspacing="0" width="898" style="border-collapse:
 ...
 width:77pt" />
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" style="height: 20.1pt;" class="style9"><input class="studentApply" type="text" id="relatives[1]_relationship" name="relationship">　</td>
		<td class="style11"><input class="studentApply" type="text" id="relatives[1]_name" name="name"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[1]_birthDate" name="birthDate">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[1]_contactNo" name="contactNo"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[1]_profectional" name="profectional">　</td>
		<td class="style11">
		<input class="studentApply" type="number" id="relatives[1]_anualIncome" name="anualIncome">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[1]_otherSponse" name="otherSponse">　</td>
		<td class="style19">
		<input class="studentApply" type="text" id="relatives[1]_health" name="health">　</td>
    </tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" style="height: 20.1pt;" class="style9"><input class="studentApply" type="text" id="relatives[2]_relationship" name="relationship">　</td>
		<td class="style11"><input class="studentApply" type="text" id="relatives[2]_name" name="name"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[2]_birthDate" name="birthDate">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[2]_contactNo" name="contactNo"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[2]_profectional" name="profectional">　</td>
		<td class="style11">
		<input class="studentApply" type="number" id="relatives[2]_anualIncome" name="anualIncome">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[2]_otherSponse" name="otherSponse">　</td>
		<td class="style19">
		<input class="studentApply" type="text" id="relatives[2]_health" name="health">　</td>
    </tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" style="height: 20.1pt;" class="style9"><input class="studentApply" type="text" id="relatives[3]_relationship" name="relationship">　</td>
		<td class="style11"><input class="studentApply" type="text" id="relatives[3]_name" name="name"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[3]_birthDate" name="birthDate">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[3]_contactNo" name="contactNo"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[3]_profectional" name="profectional">　</td>
		<td class="style11">
		<input class="studentApply" type="number" id="relatives[3]_anualIncome" name="anualIncome">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[3]_otherSponse" name="otherSponse">　</td>
		<td class="style19">
		<input class="studentApply" type="text" id="relatives[3]_health" name="health">　</td>
    </tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" style="height: 20.1pt;" class="style9"><input class="studentApply" type="text" id="relatives[4]_relationship" name="relationship">　</td>
		<td class="style11"><input class="studentApply" type="text" id="relatives[4]_name" name="name"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[4]_birthDate" name="birthDate">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[4]_contactNo" name="contactNo"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[4]_profectional" name="profectional">　</td>
		<td class="style11">
		<input class="studentApply" type="number" id="relatives[4]_anualIncome" name="anualIncome">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[4]_otherSponse" name="otherSponse">　</td>
		<td class="style19">
		<input class="studentApply" type="text" id="relatives[4]_health" name="health">　</td>
    </tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" style="height: 20.1pt;" class="style9"><input class="studentApply" type="text" id="relatives[5]_relationship" name="relationship">　</td>
		<td class="style11"><input class="studentApply" type="text" id="relatives[5]_name" name="name"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[5]_birthDate" name="birthDate">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[5]_contactNo" name="contactNo"></td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[5]_profectional" name="profectional">　</td>
		<td class="style11">
		<input class="studentApply" type="number" id="relatives[5]_anualIncome" name="anualIncome">　</td>
		<td class="style11">
		<input class="studentApply" type="text" id="relatives[5]_otherSponse" name="otherSponse">　</td>
		<td class="style19">
		<input class="studentApply" type="text" id="relatives[5]_health" name="health">　</td>
    </tr>
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		家庭经济情况</td>
		<td align="center" width="103" style="width: 77pt; layout-flow: vertical-ideographic;" class="style24">
		主要收入</td>
		<td colspan="6" width="677" style="width: 508pt" class="style25">
		1、农业生产：农田<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp; </span>亩，种植情况<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</span>，出售收入<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>元/年</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" width="103" style="height: 20.1pt; width: 77pt; layout-flow: vertical-ideographic;" class="style26">
		　</td>
		<td colspan="6" width="677" style="width: 508pt" class="style27">
		2、禽畜养殖及用途：<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</span>，出售收入<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>元/年</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" width="103" style="height: 20.1pt; width: 77pt; layout-flow: vertical-ideographic;" class="style26">
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" align="center" width="103" style="height: 20.1pt; width: 77pt; layout-flow: vertical-ideographic;" class="style29">
		主要支出</td>
		<td colspan="6" width="677" style="width: 508pt" class="style30">1、主要支出：<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" width="103" style="height: 20.1pt; width: 77pt; layout-flow: vertical-ideographic;" class="style26">
		　</td>
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td rowspan="4" height="104" align="center" width="118" style="height: 80.4pt; width: 89pt; layout-flow: vertical-ideographic;" class="style31">
		<span style="mso-spacerun:yes">&nbsp;</span>住房情况<span style="mso-spacerun:yes">&nbsp;</span></td>
		<td colspan="7" width="780" style="width: 585pt" class="style32">1.√ 
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td colspan="7" height="26" width="780" style="height: 20.1pt; width: 585pt" class="style33">
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		<td height="26" colspan="6" style="height: 20.1pt; mso-ignore: colspan" class="style35">
		3. □租用房屋<span style="mso-spacerun:yes">&nbsp;&nbsp; </span>租金：<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</span>元/月<span style="mso-spacerun:yes">&nbsp;&nbsp; </span>房屋内部装修：<span style="mso-spacerun:yes">&nbsp;
		</span>□简陋<span style="mso-spacerun:yes">&nbsp;&nbsp; </span>□水泥地<span style="mso-spacerun:yes">&nbsp;&nbsp;
		</span>□贴瓷砖<span style="mso-spacerun:yes">&nbsp;&nbsp; </span>□舒适<span style="mso-spacerun:yes">&nbsp;&nbsp;
		</span>□高档</td>
		<td class="style36">　</td>
	</tr>
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		<td class="style11">家庭环境照片</td>
		<td class="style11">学生个人独照</td>
		<td class="style11">反馈表照片</td>
		<td class="style11">发款签收照片</td>
		<td colspan="3" width="300" style="width: 225pt" class="style38">
	...
	<tr height="26" style="mso-height-source:userset;height:20.1pt">
		...
		<td class="style11">信息提供人</td>
		<td class="style11">家庭情况变化</td>
		<td colspan="5" width="574" style="width: 431pt" class="style57">
