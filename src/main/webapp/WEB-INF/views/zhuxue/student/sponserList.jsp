...
<body>
	<c:if test="${not empty message}">
		...
		<a class='handle' tkey=newsponser tname="登记新资助人"  href='#'>登记新资助人</a>   <a class='handle' tkey=importsponser tname="从Excel导入资助人信息" href='#'>从Excel导入资助人</a>    <a class='handle' tkey=importsponseregistry tname="从Excel导入资助人信息" href='#'>从Excel导入资助登记表</a>
	</div>
	...
	<div id="importsponseregistry" style="display: none" class="div_maindialog">
		<!-- table用来显示信息，方便办理任务 -->
            <%@include file="importexcel.jsp" %>
